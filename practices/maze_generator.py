...
grid_columns=[
    ...
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1))],
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,
...
grid_rows =[
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1))]
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1))]
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randin(1))(random.randint(0,1))]
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1))]
    [(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1)),(random.randint(0,1))]]
...
maze_draw.penup(50,600)
maze_draw.pendown(70,600)
